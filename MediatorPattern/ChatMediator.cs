    ...
    internal class ChatMediator
    {
        ...
        public void AddUser(User user)
        {
            if (!_users.ContainsKey(user.Name))
            {
                ...
                Console.WriteLine($"Чел {user.Name} присоединился к дискуссии.");
            }
        }
        ...
        public void RemoveUser(string userName)
        {
            if (_users.Remove(userName))
            {
                ...
                Console.WriteLine($"Чел {userName} покинул дискуссию.");
            }
        }
        ...
        public void SendMessage(User sender, string message, string recipientName)
        {
            ...
            {
                Console.WriteLine($"Чел {recipientName} не в зоне действия сети.");
            }
        ...
        public void ShowMessageHistory(string userName)
        {
            ...
            {
                Console.WriteLine($"Чел {userName} ничего не писал.");
            }
        }
    }
}